...
const Home = () => {
  ...
  return (
    <motion.div
      className="w-full min-h-screen bg-blur text-white"
    ...
    >
      ...
      <section className="relative h-screen flex items-center justify-center bg-blur overflow-hidden">
        ...
        <motion.div
          className="text-center px-4 max-w-4xl z-10 custom-box-bg rounded-xl p-8"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto bg-blur">
        <motion.h2
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              key={index}
              className="custom-box-bg rounded-xl p-6 shadow-md border border-gray-200/20"
              variants={cardVariants}
              initial="hidden"
              animate="visible"
              whileHover="hover"
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto bg-blur">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {marketSymbols.slice(0, 6).map((symbol, index) => (
            <motion.div
              key={index}
              className="custom-box-bg rounded-xl p-4 shadow-lg border border-gray-200/20"
              variants={cardVariants}
              initial="hidden"
              animate="visible"
              whileHover="hover"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                key={index}
                className="custom-box-bg rounded-xl p-6 shadow-md border border-gray-200/20 cursor-pointer"
                variants={cardVariants}
                initial="hidden"
                animate="visible"
                whileHover="hover"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <motion.div
                key={index}
                className="custom-box-bg rounded-xl p-6 shadow-md border border-gray-200/20 text-center"
                variants={cardVariants}
                initial="hidden"
                animate="visible"
                whileHover="hover"
          ...
          <motion.div
            className="custom-box-bg rounded-xl p-6 shadow-lg border border-gray-200/20"
            variants={cardVariants}
            initial="hidden"
            animate="visible"
            style={{ transformStyle: 'preserve-3d' }}
              ...
              >
                ...
                <div className="space-y-2">
                  {member.expertise.map((item, i) => (
                    <p key={i} className="text-sm custom-box-bg px-3 py-1 rounded-full inline-block m-1">
                      {item}
                    </p>
                  ))}
                </div>
          ...
          {[
            ...
            >
              ...
              <div className="flex justify-between items-end">
                ...
                <p className="text-sm custom-box-bg px-3 py-1 rounded-full">{testimonial.stats}</p>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                key={index}
                className={`relative custom-box-bg rounded-xl p-6 shadow-lg border-2 ${
      ...
      <section className="py-16 px-4 bg-blur">
        <motion.div
          className="max-w-4xl mx-auto text-center custom-box-bg rounded-xl p-8 shadow-lg border border-gray-200/20"
          variants={cardVariants}
          initial="hidden"
          animate="visible"
          style={{ transformStyle: 'preserve-3d' }}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            ...
            {[
              ...
              >
                <div
                  className={`absolute top-0 ${index % 2 === 0 ? '-right-2' : '-left-2'} w-4 h-4 rounded-full bg-gradient-to-r from-blue-500 to-purple-500`}
                ></div>
                <div
                  className={`custom-box-bg p-6 rounded-lg shadow-md border border-gray-200/20 ${
      ...
      {/* Contact Form */}
      <section ref={contactFormRef} className="py-16 px-4 bg-blur">
        <div className="max-w-2xl mx-auto custom-box-bg rounded-xl shadow-lg p-8 border border-gray-200/20">
          <motion.h2
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div>
        ...
        <input
          ...
          type="text"
          className={`w-full px-4 py-2 rounded-lg border border-gray-300/50 custom-box-bg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.name ? 'border-red-500' : ''}`}
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            type="email"
            className={`w-full px-4 py-2 rounded-lg border border-gray-300/50 custom-box-bg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.email ? 'border-red-500' : ''}`}
          />
        ...
        <div>
          ...
          <input
            ...
            type="tel"
            className={`w-full px-4 py-2 rounded-lg border border-gray-300/50 custom-box-bg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.phone ? 'border-red-500' : ''}`}
          />
      ...
      <div>
        ...
        <select
          ...
          className={`w-full px-4 py-2 rounded-lg border border-gray-300/50 custom-box-bg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.interest ? 'border-red-500' : ''}`}
        >
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className={`w-full px-4 py-2 rounded-lg border border-gray-300/50 custom-box-bg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.message ? 'border-red-500' : ''}`}
        ></textarea>
      ...
      <motion.button
        type="submit"
        disabled={submitting}
        className={`w-full py-3 rounded-lg shadow-md hover:shadow-lg transition ${
